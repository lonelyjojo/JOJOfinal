...
<body>
    ...
    <div class="login">
      <h1>修改密码</h1>
      <form onsubmit="return regist()" method="post" action=" ${pageContext.request.contextPath }/user/dochangepass.action" enctype="application/x-www-form-urlencoded">
        <p>新密码<input type="password" name="upassword" id="upassword" value="" placeholder="密码"  required="required" onblur="checkpassword()"></p>
